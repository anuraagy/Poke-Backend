class Api::V1::UsersController < Api::V1::BaseController
  ...
  def friend_requests_sent
    ...
    if user.blank?
      ...
      render status: :ok, json: { friend_requets: user.friend_requests_sent.where.not(status: "accepted").as_json }
    end
  end
  ...
  def friend_requests_received
    ...
    if user.blank?
      ...
      render status: :ok, json: { friend_requests: user.friend_requests_received.where.not(status: "accepted").as_json }
    end
  end
