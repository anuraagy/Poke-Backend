class Api::V1::UsersController < Api::V1::BaseController
  ...
  def index
    ...
    profile['activity'] = current_user.activity
  ...
  def followed_friends
    ...
    if user.blank?
      ...
      render status: :ok, json: { followed_friends: user.followed_friends.as_json }
    end
  end
